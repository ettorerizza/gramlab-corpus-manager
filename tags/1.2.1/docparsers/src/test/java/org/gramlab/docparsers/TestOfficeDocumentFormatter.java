 ...
 * Time: 15:59
 */
public class TestOfficeDocumentFormatter {
	private static final Logger logger = Logger.getLogger(TestOfficeDocumentFormatter.class);

	private static final File[] SAMPLES = new File[] {
			new File("src/test/resources/samples/samples01.doc")
	};
