 ...
 * Time: 15:59
 */
public class TestOOXMLDocumentFormatter {
	private static final Logger logger = Logger.getLogger(TestOOXMLDocumentFormatter.class);

	private static final File[] SAMPLES = new File[] {
			new File("src/test/resources/samples/samples01.docx")
	};
